...
import { Facebook, Twitter, Instagram, Linkedin, Download, Mail, Phone, MapPin, ExternalLink, Github, GraduationCap, Briefcase } from 'lucide-react';
...
and analytical skills to contribute meaningfully to an organization's objectives.
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-gray-700 p-6 rounded-lg text-center">
                <h3 className="text-4xl font-bold text-cyan-400 mb-2">30+</h3>
              ...
              <div className="space-y-8">
                <div className="relative pl-8 border-l-2 border-cyan-400 pb-8">
                  ...
                  <div className="bg-gray-800 p-6 rounded-lg">
                    ...
                    <p className="text-gray-400 mt-2">Current CGPA - 8.29/10</p>
                  </div>
                </div>
                <div className="relative pl-8 border-l-2 border-cyan-400 pb-8">
                  <div className="absolute w-4 h-4 bg-cyan-400 rounded-full -left-[9px] top-0"></div>
                  <div className="bg-gray-800 p-6 rounded-lg">
                    ...
                    <p className="text-gray-400 mt-2">Scored 78%</p>
                  </div>
                </div>
                <div className="relative pl-8 border-l-2 border-cyan-400 pb-8">
                  <div className="absolute w-4 h-4 bg-cyan-400 rounded-full -left-[9px] top-0"></div>
                  <div className="bg-gray-800 p-6 rounded-lg">
                    ...
                    <p className="text-gray-400 mt-2">Scored 73.8%</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="group relative overflow-hidden rounded-lg">
                <img
                  src={`https://images.unsplash.com/photo-167${item}099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80`}
                  alt={`Project ${item}`}
